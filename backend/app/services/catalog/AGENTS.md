...
| Layer | Modules |
| --- | --- |
| Foundation (pure) | `normalization.py`, `metadata_normalization.py`, `metadata_descriptors.py`, `metadata_schema.py`, `asset_types.py`, `runtime.py` (paths and process-local caches), `kicad_cli.py`, `signed_urls.py`, `placement_payloads.py`, `metadata_csv.py`, `inventory_csv.py` (parsing) |
